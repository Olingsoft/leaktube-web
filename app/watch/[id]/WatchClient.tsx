...
export default function WatchClient({
    ...
    return (
        <div className="max-w-[2000px] mx-auto flex flex-col xl:flex-row gap-8">
            ...
            {/* Sidebar - Related & Ads */}
            <div className="w-full xl:w-[400px] space-y-6  md:px-0 overflow-visible">
                <div className="p-4 bg-gradient-to-br from-[#1B3C53]/10 to-transparent border border-white/5 rounded-[2.5rem] relative overflow-visible group flex justify-center">
                    <HomeAdBanner />
